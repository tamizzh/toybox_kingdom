...
# Grid: 8 cols x 4 rows, ~111px. row 2 = the 7 grass shade variants (col 7 = dirt).
# Exports tile_grass_0..6 (a texture-array of green shades, mixed per cell in the
# ground shader) + tile_foam (desaturated relief tinted per kingdom).
